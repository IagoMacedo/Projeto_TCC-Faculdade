        ...
        <script>
            ...
            function Comprar_Carrinho(){
                ...
                if(numeroLinhas > 0){
                    ...
                    document.getElementById("pedido").value = items;
            ...
            function Comprar(p, d, v){
                document.getElementById("pedido").value = p + ', ' + d + ', '+  v;
            }
        </script>
    </head>
    ...
    <body class="bg-dark">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="nav-topo">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="index.php" class="btn btn-danger mt-2 mr-2 ">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-2">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Hamburguer', '', '5.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Pastel', 'Calabresa', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Misto', 'Queijo com Presunto', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <label class="ml-3">Coxinha R$3.00</label><br>
                                    ...
                                    <button  onclick="Comprar('Coxinha', 'Frango', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Misto Quente', '', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Torta', 'Frango', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Misto', '', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Pão De queijo', '', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-2">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Suco em Caixa', '', '3.50')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <label class="ml-3">Suco de Laranja R$4.50</label><br>
                                    ...
                                    <button  onclick="Comprar('Suco', 'Laranja', '4.50')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Refrigerante', 'Coca cola', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Guaraviton', 'Guarana e Açai', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                         <!-- Nova linha 1 de produtos alex-->
                         <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Gatorade', 'Laranja', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                            <!-- Nova linha 2 de produtos alex-->
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Tonica', '', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Xtapa', 'Uva', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button onclick="adicionaLinha('tbl', 'Dolly', 'Guarana', 4.00)" class="btn btn-success ml-2 mb-3" type="submit"><i class="fas fa-cart-plus"></i>Carrinho</button>
                                    <button  onclick="Comprar('Dolly', 'Guarana', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-2">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Café com Leite', '', '3.50')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Chá Quente', '', '4.50')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <label class="ml-3"> Café R$3.00</label><br>
                                    <button onclick="adicionaLinha('tbl', 'Café','', 3.00)" class="btn btn-success ml-2 mb-3" type="submit"><i class="fas fa-cart-plus"></i>Carrinho</button>
                                    <button  onclick="Comprar('Café', '', '3.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Cappuccino', '', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        <!-- Nova linha 1 de produtos alex-->
                         <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Macchiato', 'Italiano', '4.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                            <!-- Nova linha 2 de produtos alex-->
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <button  onclick="Comprar('Chocolate Quente', 'Chocolate', '5.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 mb-3">
                            <div class="bg-warning borda-items"> 
                                <div class="items">
                                    ...
                                    <label class="ml-3" id='produto'>Quentão de Chocolate R$5.00</label><br>
                                    <button onclick="adicionaLinha('tbl', 'Quentão', 'Chocolate', 5.00)" class="btn btn-success ml-2 mb-3" type="submit"><i class="fas fa-cart-plus"></i>Carrinho</button>
                                    <button  onclick="Comprar('Quentão', 'Chocolate', '5.00')" data-toggle="modal" data-target="#modalCompra"  class="btn btn-success ml-2 mb-3" type="button"><i class="fas fa-credit-card mr-1"></i>Comprar</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <center>
                            <form method="POST" action="verificaCompra.php" class="form-group">
                                
                                <input type="submit" onclick="Comprar_Carrinho()" class="btn btn-success" name="btn_Comprar" value="Comprar"  data-toggle="modal" data-target="#modalCompra" data-dismiss="modal">
                            </form>
                        </center>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modalCompra" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" class="form-group row justify-content-center mt-3" action="validaCompra.php">
                            
                            <h1 class="">Dados Do Cartão</h1>
                            <div class="col-12 col-lg-10">
                                Nome:<br>
                                <input class="form-control mt-1 mb-3" type="text" placeholder="Digite o seu nome igual esta no cartão" name="txtnome" required>
                            </div>
                            <div class="col-8 col-lg-7">
                                N° Do cartão:<br>
                                <input class="form-control mt-1 mb-3" type="text" placeholder="Digite o numero do seu cartão" name="txtncartao" maxlength="16" required>
                            </div>
                            <div class="col-4 col-lg-3">
                                CVV:<br>
                                <input class="form-control mt-1 mb-3" type="text" name="txtcvv" maxlength="3" required>
                            </div>
                            <div class="col-5 col-lg-4">
                                Validade:<br>
                                <input class="form-control mt-1 mr-4 mb-3" type="text" placeholder="mes/ano" name="txtdatav" required>
                            </div>
                            <div class="col-7 col-lg-6">
                                CPF:<br>
                                <input class="form-control mt-1 mr-4 mb-3" type="text" placeholder="Digite seu cpf" name="txtcpf" maxlength="11" required>
                                <input type="hidden" name="txtpedidos" id="pedido">
                            </div>
                            <div class="col-6 col-lg-5">
                                <a href="validaCompra.php">
                                    <input class="form-control btn btn-success mb-2" type="submit" name="btnconfirmar" value="Confirmar Compra"></a>
                                </a>
                            </div>
        ...
        <div class="modal fade" id="modalPedidos" tabindex="-1" role="dialog" >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title">Meu Pedido</h4>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <?php
                        
                            $arquivo = "QRCODE/pedidos".$_SESSION['Id'].".svg";
                            if(file_exists($arquivo)){
                                ?><center>
                                    <iframe src=<?php echo "QRCODE/pedidos".$_SESSION['Id'].".svg";?>  scrolling="no" width='200'height="200" style="overflow:hidden;"></iframe>
                                </center>
                            <?php
                            }
                            else{
                                echo "<center><h3 class='text-dark bg-warning rounded'>Você não tem pedidos no mmomento</h1></center>";
                            }
